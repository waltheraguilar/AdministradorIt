...
import 'package:itadministrador/servicios/autenticacion/crud/excepciones_crud.dart';
...
return notes.map((notaFila) => DatabaseNote.fromRow(notaFila));
...
//create tha note
  ...
  Future<void> deteleUser({required String email}) async {
      await _ensureDbIsOpen();
    final db = _getDatabaseOrThrow();

    final deletedCount = await db.delete(
      userTable,
      where: 'email = ?', //signo de interrogacion es un parametro
...
import 'package:flutter/widgets.dart';
import 'package:itadministrador/servicios/autenticacion/crud/excepciones_crud.dart';
import 'package:itadministrador/utilities/filtro.dart';
